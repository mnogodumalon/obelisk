    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-14 justify-start">
        ...
        >
          ...
          <div className="bg-neutral-950 p-5 flex-1 rounded-3xl border-r-[1px] border-blue-number/20">
        ...
        >
          <img
            className="absolute md:-bottom-1/2"
            src={BgNumber}
            alt="Number Background"
          />
          <h2 className="absolute md:-bottom-[8%] left-[46%] text-5xl text-blue-number">
            2
          </h2>
          <div className="bg-neutral-950 py-5 px-[27px] flex-1 rounded-3xl border-l-[1px] border-blue-number/20">
        ...
        >
          ...
          <div className="bg-neutral-950 py-5 px-[68px] flex-1 rounded-3xl border-r-[1px] border-blue-number/20">
